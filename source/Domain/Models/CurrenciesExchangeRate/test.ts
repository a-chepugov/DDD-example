...
describe("Models", () => {
    ...
    describe("CurrenciesExchangeRate", () => {
        ...
        it("USD/EUR rate equals USD/EUR rate", () => {
            ...
            const testee1 = new Testee(new Currency('USD'), new Currency('EUR'), timestamp, 1.5);
            const testee2 = new Testee(new Currency('USD'), new Currency('EUR'), timestamp, 1.5);
        ...
        it("USD/EUR rate no equals USD/JPY rate", () => {
            const timestamp = Date.now();
            const testee1 = new Testee(new Currency('USD'), new Currency('EUR'), timestamp, 1.5);
            const testee2 = new Testee(new Currency('USD'), new Currency('JPY'), timestamp, 1.5);

            expect(testee1.equals(testee2)).to.be.equal(false);
        });

        it("USD/EUR rate no equals USD/EUR rate next moment", () => {
            const timestamp = Date.now();
            const testee1 = new Testee(new Currency('USD'), new Currency('EUR'), timestamp, 1.5);
            const testee2 = new Testee(new Currency('USD'), new Currency('JPY'), timestamp + 1, 1.5);
        ...
        it("USD/EUR rate no equals another USD/EUR rate", () => {
            const timestamp = Date.now();
            const testee1 = new Testee(new Currency('USD'), new Currency('EUR'), timestamp, 1.5);
            const testee2 = new Testee(new Currency('USD'), new Currency('EUR'), timestamp, 1.2);
        ...
        it("estimate 10 EUR", () => {
            ...
            const testee1 = new Testee(EUR, USD, timestamp, 1.5);
